...
function createTeacherRecord (teacherFN: string, teacherLN: string, teacherGrade:number ) {
    let greetTeacher =`Good morning ${teacherFN} ${teacherLN}`
    return {
        teacherFN,
        teacherLN,
        greetTeacher,
        isHighSchoolTeacher(){ return teacherGrade>7}
    }
}
let teacher1 = createTeacherRecord('Mona', 'Rick', 10)
